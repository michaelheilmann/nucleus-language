...
{
    Nucleus_Language_String *pathname = Nucleus_Language_String_create(context, "data/helloworld.txt",
                                                                       strlen("data/helloworld.txt"));
    Nucleus_Language_String *reference = Nucleus_Language_String_create(context, "Hello, World!\r\n", strlen("Hello, World!\r\n"));
    Nucleus_Language_Context_setFileContentsString(context, pathname, reference);
    Nucleus_Language_String *contents = Nucleus_Language_Context_getFileContentsString(context, pathname);
