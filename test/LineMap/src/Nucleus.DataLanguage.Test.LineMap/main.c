...
test
    (
        const char *pathname,
        void (*test)(Nucleus_DataLanguage_Context *, Nucleus_DataLanguage_LineMap *)
    )
{
    Nucleus_DataLanguage_Context *context;
    ...
    if (!setjmp(jt.environment))
    {
        ...
        Nucleus_DataLanguage_LineMap *lineMap = Nucleus_DataLanguage_LineMap_create(context, inputString);
        Nucleus_DataLanguage_LineMap *lineMap2 = Nucleus_DataLanguage_LineMap_create(context, inputString);
        Nucleus_DataLanguage_LineMap *lineMap3 = Nucleus_DataLanguage_LineMap_create(context, inputString);
        (*test)(context, lineMap);
    }
