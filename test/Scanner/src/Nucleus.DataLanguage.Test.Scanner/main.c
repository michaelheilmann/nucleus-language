    ...
    )
{
    ...
    DL_UnitTest_AssertTrue(context, Nucleus_DataLanguage_String_equal(context, Nucleus_DataLanguage_Token_getText(context, token),
                                                                      Nucleus_DataLanguage_String_create(context, "[", sizeof("[") - 1)));
    ...
    )
{
    ...
    DL_UnitTest_AssertTrue(context,Nucleus_DataLanguage_String_equal(context, Nucleus_DataLanguage_Token_getText(context, token),
                                                                     Nucleus_DataLanguage_String_create(context, "true", sizeof("true") - 1)));
    token = Nucleus_DataLanguage_Scanner_scan(context, scanner);
    DL_UnitTest_AssertTrue(context, Nucleus_DataLanguage_Token_getKind(context, token) == Nucleus_DataLanguage_Token_Kind_End);
}
    ...
    )
{
    ...
    DL_UnitTest_AssertTrue(context,Nucleus_DataLanguage_String_equal(context, Nucleus_DataLanguage_Token_getText(context, token),
                                                                     Nucleus_DataLanguage_String_create(context, "false", sizeof("false") - 1)));
    token = Nucleus_DataLanguage_Scanner_scan(context, scanner);
    DL_UnitTest_AssertTrue(context, Nucleus_DataLanguage_Token_getKind(context, token) == Nucleus_DataLanguage_Token_Kind_End);
}
